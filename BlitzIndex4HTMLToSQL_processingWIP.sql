...
IF OBJECT_ID(N'dbo.PSBlitzIndexDiagnosis', N'U') IS NULL
  BEGIN
      CREATE TABLE [dbo].[PSBlitzIndexDiagnosis]
  (
     ...
     [DataPrep]       [NVARCHAR](300) NULL,
     [ObjectName]     [NVARCHAR](max) NULL,
     [SamplePlanFile] [NVARCHAR](200) NULL
  );
  END;
/*
to do: 
...
INSERT INTO [dbo].[PSBlitzIndexDiagnosis]
            ([Priority],
             [Finding],
             [DatabaseName],
             [Details],
